...
(function (e) {
    e.support.cssPseudoClasses = function () {
        ...
        return t && (n = t instanceof jQuery ? e(t).wrap("<div />").parent().html() : t), i.each(function () {
            var t = e(this);
            t.wrap('<div class="fileinput-wrapper" style="overflow:hidden; position: relative; display: inline-block;" />'), t.parent().mousemove(function (t) {
                var i, n, s = e(this);
                i = s.offset().left, n = s.offset().top, s.find("input").css({
                    left: t.pageX - i - s.find("input[type=file]").width() + 30,
                    top: t.pageY - n - 10
                })
                ...
                position: "absolute",
                "z-index": -1
            }), t.before(n), t.prev().addClass("fileinput"), e.support.cssPseudoClasses ? (t.prev(".fileinput").click(function () {
                t.click()
                ...
                "z-index": "auto",
                cursor: "pointer"
            }), t.prev(".fileinput").css("z-index", -1), t.removeAttr("tabindex"), t.prev(".fileinput").attr("tabindex", "-1"), t.hover(function () {
